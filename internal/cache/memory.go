...
func (m *memoryCache) Lock(ctx context.Context, key string, expiration time.Duration, extendInterval time.Duration) (Lock, error) {
...
func (m *memoryCache) WaitForLock(ctx context.Context, key string, expiration, extendInterval time.Duration) (Lock, error) {
	return waitForLock(ctx, m, key, expiration, extendInterval)
}
