...
func (r *redisCache) Lock(ctx context.Context, key string, expiration time.Duration, extendInterval time.Duration) (Lock, error) {
...
func (r *redisCache) WaitForLock(ctx context.Context, key string, expiration, extendInterval time.Duration) (Lock, error) {
	return waitForLock(ctx, r, key, expiration, extendInterval)
}
